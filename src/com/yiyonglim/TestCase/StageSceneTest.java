...
public class StageSceneTest {
	...
	public void testActor() {
		...
		assertEquals(0,test.getObjects(Obstacle.class).size()) ;
		...
		System.out.println("array size : " + test.getObjects(Obstacle.class).size()+ " , " + test.getObjects(Obstacle.class));
		System.out.println("array size : " + test.getObjects(Digit.class).size()+ " , " + test.getObjects(Digit.class));
		
		// Each of Actor's class is added into stage scene
		...
		test.add(new Obstacle("file:Resources/Car/carLeft.png", 150, 704, -5, 50, 50));
		...
		assertEquals(1,test.getObjects(Obstacle.class).size()) ;
	...
	public void testStageProceed() {
		...
		assertEquals(0 , StageScene.end) ;
		
		System.out.println("Before frog reach stage 1's goal :") ;
		System.out.println("end : " + StageScene.end);
