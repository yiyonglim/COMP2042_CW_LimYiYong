...
public class Stage4 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		StageBackgroundImage froggerback = new StageBackgroundImage("file:Resources/StageBackground/Stage4Background.png") ;
		...
		stageScene.add(new End(393,105));
		...
		stageScene.add(new Obstacle("file:Resources/Truck/truck1Right.png", 600, 649, 5, 120, 120)) ;
		stageScene.add(new Obstacle("file:Resources/Truck/truck2Right.png", 300, 540, 8, 200, 200)) ;
		
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 150, 704, -5, 50, 50)) ;
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 500, 704, -5, 50, 50)) ;
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 100, 597, -5, 50, 50)) ;
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 550, 597, -5, 50, 50)) ;
