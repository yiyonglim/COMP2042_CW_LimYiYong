...
public class Stage3 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		StageBackgroundImage froggerback = new StageBackgroundImage("file:Resources/StageBackground/Stage3Background.png") ;
		...
		stageScene.add(new End(265,105));
		...
		stageScene.add(new Obstacle("file:Resources/Truck/truck1Right.png", 0, 649, 1, 120, 120)) ;
		stageScene.add(new Obstacle("file:Resources/Truck/truck1Right.png", 300, 649, 1, 120, 120)) ;
		stageScene.add(new Obstacle("file:Resources/Truck/truck1Right.png", 600, 649, 1, 120, 120)) ;
		stageScene.add(new Obstacle("file:Resources/Truck/truck2Right.png", 0, 540, 1, 200, 200)) ;
		stageScene.add(new Obstacle("file:Resources/Truck/truck2Right.png", 500, 540, 1, 200, 200)) ;
		...
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 250, 597, -1, 50, 50)) ;
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 400, 597, -1, 50, 50)) ;
		...
		stageScene.add(new Obstacle("file:Resources/Car/carLeft.png", 700, 490, -5, 50, 50)) ;
